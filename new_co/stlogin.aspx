<%@ Page Title="" Language="C#" MasterPageFile="~/all.Master" AutoEventWireup="true" CodeBehind="stlogin.aspx.cs" Inherits="new_co.stlogin" %>
        ...
        <tr>
            ...
            <td class="style5" colspan="2">
                <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Red" 
                    NavigateUrl="~/studentreg.aspx">Not Register?</asp:HyperLink>
