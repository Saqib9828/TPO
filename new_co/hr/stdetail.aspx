<%@ Page Title="" Language="C#" MasterPageFile="~/hr/hr.Master" AutoEventWireup="true" CodeBehind="stdetail.aspx.cs" Inherits="new_co.hr.stdetail" %>
    ...
    <table class="style1" style="color: #000000">
        ...
        <tr>
            ...
            <td class="style8">
                &nbsp;CV</td>
            <td>
                <asp:HyperLink ID="HyperLink1" runat="server">Click Here to View</asp:HyperLink>
            </td>
            <td>
                &nbsp;</td>
            <td>
        ...
        <tr>
            ...
            <td class="style13">
                ID</td>
            <td class="style12">
                <asp:HyperLink ID="HyperLink2" runat="server">Click Here to View</asp:HyperLink>
            </td>
            <td class="style12">
                </td>
            <td class="style12">
        ...
        <tr>
            <td align="center" class="style2" colspan="5">
                <asp:DropDownList ID="DropDownList1" runat="server">
                    ...
                    <asp:ListItem>Under Selection Process</asp:ListItem>
                    <asp:ListItem>Selected</asp:ListItem>
                    <asp:ListItem>Rejected</asp:ListItem>
                </asp:DropDownList>
             <td>
                <asp:Button ID="Button1" runat="server" BackColor="#483E35" ForeColor="White" 
                    Height="33px" onclick="Button1_Click" Text="Update" Width="93px" /></td>
            <td>
